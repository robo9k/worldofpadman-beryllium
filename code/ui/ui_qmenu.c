...
void Menu_Draw( menuframework_s *menu )
{
	...
	if(uis.dropdownlist)
	{
		...
		UI_FillRect(uis.dropdownxywh[0],uis.dropdownxywh[1],uis.dropdownxywh[2],uis.dropdownxywh[3],uis.dropdownlist->dropdown_bg);
		...
		UI_DrawRect(uis.dropdownxywh[0],uis.dropdownxywh[1],uis.dropdownxywh[2],uis.dropdownxywh[3],uis.dropdownlist->dropdown_border);
	}
...
void Menu_Cache( void )
{
	...
	menu_switch_sound = trap_S_RegisterSound( "sound/menu/menuSwitch.wav", qfalse );
	menu_click_sound = trap_S_RegisterSound( "sound/menu/MouseClick.wav", qfalse );
	menu_move_sound = trap_S_RegisterSound( "sound/menu/MouseOver.wav", qfalse );
	menu_buzz_sound	= trap_S_RegisterSound( "sound/menu/menuError.wav", qfalse );
