...
/*	{"messagemode3", 	"chat - target",	ID_CHAT3,		ANIM_CHAT,		-1,				-1,		-1, -1},
	...
	{"wop_music",		"WoP music menu",	ID_MUSIC,		ANIM_IDLE,		'm',			-1,		-1, -1},
	...
	{"toggle cg_drawServerInfos","toggle ServerInfo",ID_SERVERINFO,ANIM_IDLE,'k',			-1,		-1, -1},
	{"toggle cg_thirdPerson","toggle 3rdPersonView",ID_3RDPERSON,ANIM_IDLE,	'u',			-1,		-1, -1},
...
static configcvar_t g_configcvars[] =
{
	...
	{"m_filter",		0,					0},
	{"cl_freelook",		0,					0},
	{"wop_AutoswitchSongByNextMap",	0,		0},
	{NULL,				0,					0}
};
...
static menucommon_s *g_misc_controls[] = {
	...
	(menucommon_s *)&s_controls.musicautoswitch,
...
static void Controls_GetConfig( void )
{
	...
	s_controls.musicautoswitch.curvalue= UI_ClampCvar( 0, 1, Controls_GetCvarValue("wop_AutoswitchSongByNextMap"));
...
static void Controls_SetConfig( void )
{
	...
	trap_Cvar_SetValue( "wop_AutoswitchSongByNextMap", s_controls.musicautoswitch.curvalue );
...
static void Controls_SetDefaults( void )
{
	...
	s_controls.musicautoswitch.curvalue= Controls_GetCvarDefault( "wop_AutoswitchSongByNextMap" );
...
static void Controls_MenuInit( void )
{
	...
	// wop_AutoswitchSongByNextMap
	s_controls.musicautoswitch.generic.type		= MTYPE_RADIOBUTTON;
	s_controls.musicautoswitch.generic.flags	= QMF_SMALLFONT;
	s_controls.musicautoswitch.generic.x		= SCREEN_WIDTH/2;
	s_controls.musicautoswitch.generic.name		= "switchsong by nextmap";
	s_controls.musicautoswitch.generic.id		= ID_MUSICAUTOSWITCH;
	s_controls.musicautoswitch.generic.callback	= Controls_MenuEvent;
	s_controls.musicautoswitch.generic.statusbar= Controls_StatusBar;
...
//	s_controls.chat4.generic.id        = ID_CHAT4;
	...
	s_controls.music.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	...
	s_controls.nextSong.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	...
	s_controls.dropCart.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	...
	s_controls.ServerInfo.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	...
	Menu_AddItem( &s_controls.menu, &s_controls.musicautoswitch );
