...
static void UI_DisplayOptionsMenu_Init( void ) {
	...
	displayOptionsInfo.display.generic.y		= 37;
	...
	displayOptionsInfo.sound.generic.x			= 57;
	...
	displayOptionsInfo.network.generic.x		= 194;
	displayOptionsInfo.network.generic.y		= 94;
	displayOptionsInfo.network.width			= 95;
	...
	displayOptionsInfo.ignoreHWG.generic.flags		= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	...
	displayOptionsInfo.screensize.generic.x			= 175;
