...
//spray anfang
//extern vmCvar_t	logolist; // ohne var ... damit man nicht das 256 limit hat (value hat in engine kein limit!)
//spray ende
//lens anfang
//extern vmCvar_t	lensflarelist;
//lens ende
extern vmCvar_t	spraycolor;
extern vmCvar_t	syc_logo;
extern vmCvar_t	s_wop_restarted;
extern vmCvar_t	con_notifytime;
extern vmCvar_t	ui_useUDPserverlist;
...
#define BGP_MAINBG				0x00001
#define BGP_MAINFRAME			0x00002
#define BGP_SETUPBG				0x00004
#define BGP_SYSTEMBG			0x00008
#define BGP_DEFAULTSBG			0x00010
#define BGP_EXITBG				0x00020
#define BGP_CONTROLBG			0x00040
#define BGP_PLAYERBG			0x00080
#define BGP_SERVER2BG			0x00100
#define BGP_MODSBG				0x00200
#define BGP_DEMOBG				0x00400
#define BGP_SPECIFYBG			0x00800
#define	BGP_GAMEOPTIONS			0x01000
#define BGP_STARTSERVERMAPS		0x02000
#define BGP_STARTSERVERBOTS		0x04000
#define BGP_SIMPLEBG			0x08000
#define	BGP_LASTMENU			0x10000
...
//"menu/main/Logo"
	char				logo_names[64][32];
	qhandle_t			logo_handles[64];
	int					logo_loaded;
...
// wop_advanced2d.c
//
#include "../cgame/wop_advanced2d.h"
