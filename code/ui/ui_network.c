...
static void UI_NetworkOptionsMenu_Init( void ) {
	...
	networkOptionsInfo.display.generic.y			= 37;
	...
	networkOptionsInfo.sound.generic.x				= 57;
	...
	networkOptionsInfo.network.generic.x			= 194;
	networkOptionsInfo.network.generic.y			= 94;
	networkOptionsInfo.network.width				= 95;
	...
	networkOptionsInfo.rate.generic.x			= 175;
